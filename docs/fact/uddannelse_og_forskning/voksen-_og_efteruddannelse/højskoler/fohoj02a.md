...
- `alder` total code is `'TOT'` (not a numeric code). Age groups: `-17`, `1821`, `2225`, `2629`, `3039`, `4049`, `5059`, `6099`.
- `hoej_udd_fam` is the highest education level in the family (not the individual's own education). Use fohoj03a for the individual's own education.
- This table covers only mellemlange og lange kurser. For korte kurser with education breakdown, use fohoj03a.