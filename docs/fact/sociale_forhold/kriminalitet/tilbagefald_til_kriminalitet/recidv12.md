...
- tidldom: ColumnValues shows id=0 twice — metadata quirk; only one code 0 = I alt.
- strafart2 is punishment at the strictest sentence in the follow-up period (codes 0/100-105). strafart2=0 = I alt. ColumnValues shows id=0 twice.
- rechen: 0=I alt, 106=Ingen tilbagefald, 107-111=recidivism counts.
- 5 dimension columns all have total rows. Clean total: konams='TOT', alder='0', tidldom=0, rechen=0, strafart2=0, single tid.
