...
notes:
- This table covers regionale (regional) workplaces only — no sektor column needed.
- omrade joins dim.nuts at niveau 1 (5 regions). Code '0'=Hele landet is not in dim.nuts.
- arbfunk joins dim.disco at niveau 4 (regional job functions like sygepleje, socialrådgivning, etc.). 'TOT'=I alt does not join.
- Use ColumnValues("disco", "titel", for_table="fra028") to see the 13 regional arbfunk codes.
