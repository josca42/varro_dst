...
- scene: values [101=Produktioner i alt, 195=Stationært på egen scene, 200=Turné i Danmark]
...
notes:
- scene: 101=Produktioner i alt is the aggregate of 195 (stationær, egen scene) + 200 (turné i Danmark). Filter to one value.
- pubgrup: 216=Publikumsgrupper i alt is the aggregate; 410=Voksne, 415=Unge, 420=Børn og familier are non-overlapping subcategories that sum to 216. Filter to one.
...
- This table counts productions (not performances or audience). For opførelser use scene03a, for tilskuere use scene04a.