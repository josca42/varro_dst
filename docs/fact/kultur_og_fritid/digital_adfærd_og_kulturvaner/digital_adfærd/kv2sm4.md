table: fact.kv2sm4
description: Forbrug af online videoer efter hyppighed, køn, alder og tid
...
- hyp (frequency) values are mutually exclusive. '111000' = har ikke set online videoer inden for seneste 12 måneder.
- 2024 data only.
