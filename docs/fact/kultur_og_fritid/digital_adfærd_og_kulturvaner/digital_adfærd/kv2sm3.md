table: fact.kv2sm3
description: Forbrug af influencer-indhold efter hyppighed, køn, alder og tid
...
- hyp (frequency) values are mutually exclusive. '111000' = har ikke set influencer-indhold i seneste 12 måneder.
- 2024 data only.
