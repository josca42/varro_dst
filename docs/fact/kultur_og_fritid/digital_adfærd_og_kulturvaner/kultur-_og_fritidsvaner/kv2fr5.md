...
notes:
- Percentage of people who visit religious venues at each frequency. hyp values are mutually exclusive per respondent and sum to ~100% per kon+alder (same hyp scale as kv2fr1).
- To get "% who visit at all": sum hyp 110200 through 110800 (exclude 111000, 111100, 111200).
