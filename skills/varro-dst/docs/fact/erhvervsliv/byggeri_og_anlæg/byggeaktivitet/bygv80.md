...
notes:
- This is the delay-corrected (korrigeret) version of total etageareal — no regional breakdown. For regional data use bygv11.
- anvendelse joins dim.byganv at niveauer 2 and 3. Code 'UOPL' is not in the dim.
- bygfase has 4 mutually exclusive phases — always filter to one when aggregating. Goes back to 1998, giving a longer series than bygv11 (2006).
