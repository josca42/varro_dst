table: fact.aindk3
description: Udbetalt A-indkomst efter område, enhed, køn, alder, indkomstinterval og tid
...
- indkintb='0' is "Alle" (total). Same 25k-step bracket structure as aindk2.
